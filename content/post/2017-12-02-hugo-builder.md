...
嫁の[久しぶりのブログ、新しいブログ -Advent02-]({{< relref "./2017-12-02.md" >}})で書かれていたので少しだけ解説を付け足しておこう。このブログがどうやって動いているのか。
...
### Cloudflare
これは[ブログ移行計画 -ラスト- ドメイン修正]({{< relref "./2017-11-30-domain-transfer.md" >}})に書いてあるので参考に。
